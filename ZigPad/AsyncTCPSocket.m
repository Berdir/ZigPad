...
@interface AsyncTCPSocket (Private)
...
- (void)doAcceptWithSocket:(CFSocketNativeHandle)newNative
{
	...
	AsyncTCPSocket *newSocket = [[[[self class] alloc] initWithDelegate:theDelegate] autorelease];
...
static void MyCFSocketCallback (CFSocketRef sref, CFSocketCallBackType type, CFDataRef address, const void *pData, void *pInfo)
{
	...
	AsyncTCPSocket *socket = [[(AsyncTCPSocket *)pInfo retain] autorelease];
